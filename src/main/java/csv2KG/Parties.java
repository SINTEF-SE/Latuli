...
public class Parties {
	...
	public static void processSimplePartiesToNTriple (File partiesFolder, String ntFile) {
	...
	public static void processSimplePartiesToTSV(File partiesFolder, String tsvFile) {
