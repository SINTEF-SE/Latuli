...
public static void processSimpleXDocLoadingUnitsToNTriple (File xdluFolder, String ntFile) {
	...
	public static void processSimpleXDocLoadingUnitsToTSV (File xdluFolder, String tsvFile) {
