...
public class Consignments {
	...
	public static void processSimpleConsignmentsToNTriple (File consignmentFolder, String ntFile) {
	...
	public static void processSimpleConsignmentsToTSV (File consignmentFolder, String tsvFile) {
